# VMT Project Planning

**Status**: Active

This directory contains the strategic vision, roadmap, and detailed implementation plans for the VMT project.

## Document Structure

- **[0_VMT_Roadmap.md](./0_VMT_Roadmap.md)**: The master document. It contains the high-level vision, core architecture, and a summary of the implementation roadmap. Start here to understand the project's goals and current status.
